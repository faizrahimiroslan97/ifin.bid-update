  ...
  return (
    <div className="flex flex-col gap-y-8 pb-4 pt-4 font-poppins">
      <div className="h-232 w-full rounded-2xl border-2 border-gray-300 bg-white shadow-md drop-shadow-md">
        <div className="flex flex-col gap-y-4 px-8">
          ...
          <div className="mt-6 flex flex-row gap-x-4">
            <div className="flex w-1/2 flex-row">
              <div className="ml-48 flex gap-x-2 text-lg">
                <div>
        ...
        <div className="fixed bottom-0 flex w-full flex-row justify-between border-t-2 border-gray-600">
          <Link
            to="/ifin/applications/terminate"
            className="mx-2 w-full border-t-4 border-transparent px-4 py-4 text-center text-red-800 hover:cursor-pointer hover:border-t-4 hover:border-red-800 hover:font-semibold"
          >
            <p className="text-lg">Terminate Service</p>
          </Link>
        </div>
      </div>
          ...
          <div className="accordion">
            <div className="accordion-item">
              <div
                className={
                  isActive
                    ? "accordion-title rounded-t-md border border-b-0 border-black drop-shadow-md"
                    : "accordion-title rounded-md border border-black"
                }
